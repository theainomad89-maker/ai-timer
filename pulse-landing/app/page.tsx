  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-b from-pulse to-white">
        <div className="mx-auto max-w-7xl px-5 lg:px-7 py-20">
          {/* Custom column widths: text 1.15fr, phone 1fr */}
          <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_1fr] items-center gap-10 lg:gap-14">
            
            {/* LEFT: move text right via left padding, keep a readable max width */}
            <div className="max-w-xl lg:pl-8 xl:pl-14">
              <h1 className="hero-title">
                Generate Timers Instantly with AI
              </h1>
              <p className="mt-5 hero-subtitle leading-relaxed">
            ...
            <div className="flex justify-center lg:justify-start lg:-mr-5 order-first lg:order-last">
      ...
      {/* Value props */}
      <section className="bg-graybg -mt-3">
        <div className="mx-auto max-w-7xl px-5 py-7 grid md:grid-cols-3 gap-7">
          {[
            ...
            { title: "Stay on Track", body: "Clean design, haptics, and smart intervals keep you focused." }
              ...
              <div key={i} className="rounded-2xl bg-white p-7 shadow-soft">
                <h3 className="feature-title">{f.title}</h3>
                <p className="text-slate-600 mt-3 body-text leading-relaxed">{f.body}</p>
              </div>
            ))}
        </div>
      </section>
      ...
      <section id="screens" className="py-7">
        <div className="mx-auto max-w-7xl px-5">
          <h2 className="section-title">See Pulse in Action</h2>
          <p className="text-slate-600 mt-3 body-text leading-relaxed">
      ...
      <section id="privacy" className="bg-graybg py-7">
        <div className="mx-auto max-w-3xl px-5">
          <h2 className="section-title">Privacy Policy</h2>
          <p className="text-slate-700 mt-5 body-text leading-relaxed">
